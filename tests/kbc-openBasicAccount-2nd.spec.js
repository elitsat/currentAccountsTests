...
test.describe('KBC - Open basic account for myself and someone else', () => {

    test('Open basic account for myself and someone else', async ({ page }) => {
        ...
        // Open an account for myself and someone else
        await page.locator('maia-oscar-radio-button').locator('text="Myself and someone else"').click();

        // Choose one or two cards
        await page.locator('button.boolean-selection-button:has-text("Yes")').click();
        ...
        //const uploadFront=page.locator('section[role="dialog"]').first();
        ...
        //await page.waitForSelector('text="front.pdf"');
        ...
        //await page.waitForSelector('text="back.pdf"');
        ...
        //await page.waitForSelector('text="work_proof.jpeg"');
